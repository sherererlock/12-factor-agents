...
然后从模型库中部署 [Qwen3 32B](https://www.baseten.co/library/qwen-3-32b/)。
...
如果你想不作任何更改直接运行示例，可以将 BASETEN_API_KEY 环境变量设置为任何有效的 baseten 密钥。
...
例如，要使用 openai 和 OPENAI_API_KEY，你可以这样做：
